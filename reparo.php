    ...
    <body>
        ...
        <div class="w3-top">
            <div class="w3-bar w3-red w3-card w3-left-align w3-large">
                ...
                <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Seu Negócio!</a>
		...
		<header class="w3-container w3-red w3-center" style="padding:70px 16px">
            <h1 class="w3-margin w3-Jumbo">Reparo</h1>
        </header>

        <?php
                        if ($result = $conn->query("SELECT * from casos where area = 'Reparo'")) {
